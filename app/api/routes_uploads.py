...
from app.schemas.documet import TherapistNoteCreateRequest, TherapistNoteResponse
...
def upload_therapist_note(
    ...
    logger.info(
        "Therapist note ingested successfully for child_id=%s document_id=%s chunks=%s",
        payload.child_id,
        document.id,
